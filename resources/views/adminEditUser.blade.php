    ...
    <div class="center-page">
        ...
        <form method="POST" action="{{ route('admin.edit-user', ['id' => $user->id]) }}">
            ...
            <div class="input-row-container">
                ...
                <input class="text-input-container" type="email" name="email" value="{{ $user->email }}">
            </div>
            <div class="input-row-container">
                <label>Password:</label>
                <input class="text-input-container" type="password" name="password" value="{{ $user->password }}">
            </div>
