<nav class="topbar">
    ...
    <div class="top-bar-right">
        ...
        @else
        <a class="button" id="login-button"> <i class="fa-solid fa-right-to-bracket"></i> Login</a>
        <a class="button" id="register-button"> <i class="fa-solid fa-align-justify"></i> Register </a>
        @endauth
    </div>
